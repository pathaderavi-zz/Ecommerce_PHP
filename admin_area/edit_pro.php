...
<a href="http://176.32.230.51/eschoppes.com/admin_area/index.php?view_products">Back to Products</a>
...
if(isset($_POST['update_product'])){
    ...
    $update_product = "update products set product_cat='$product_cat',product_brand='$product_brand',product_title='$product_title',products_price='$product_price',product_desc='$product_desc', product_keywords='$product_keywords' where product_id='$update_id'";
	...
	$query = 'SELECT customer_id FROM notifications WHERE product_id = ' . $update_id;
	...
	foreach($customers as $customer){
		...
		$query = 'SELECT customer_email FROM customers WHERE customer_id = ' . $customer;
		...
		// subject
		$subject = 'Product: ' . $product_title . ' has changed';
		...
		<body>
		  <p>A product has changed! <a href="http://'.$_SERVER['HTTP_HOST'].'/eschoppes.com/details.php?pro_id='.$update_id.'">Click Here</a> to view the product.</p>
		</body>
		</html>
		';
